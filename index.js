...
let donotScrollThisTime = false; // لمنع النزول التلقائي عند تحميل القديم
...
// البداية بـ 15 رسالة فقط لسرعة التصفح
...
// دالة جلب الرسايل الأقدم وزيادة الليميت بمقدار 15 في كل ضغطة
window.loadMoreMessages = function() {
    donotScrollThisTime = true; // تفعيل الحماية لمنع الشاشة من النزول المفاجئ
    showToast("Loading older messages... ⏳");
    startMessagesSubscription(currentMessagesLimit + 15);
};
